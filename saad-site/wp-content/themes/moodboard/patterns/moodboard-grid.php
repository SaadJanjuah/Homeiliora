 ...
 * Slug: moodboard/moodboard-grid
 * Categories: query, posts, featured
 * Description: The signature asymmetric masonry grid of post cards — image-forward, mixed heights, like a pinboard.
 * Keywords: grid, masonry, posts, cards, moodboard
 * Block Types: core/query
 */
?>
<!-- wp:query {"queryId":1,"query":{"perPage":12,"pages":0,"offset":0,"postType":"post","order":"desc","orderBy":"date","inherit":false},"className":"moodboard-query","layout":{"type":"default"}} -->
